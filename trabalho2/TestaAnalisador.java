...
public class TestaAnalisador {
    ...
    // Modifique-a para testar os demais exemplos
        ...
        ANTLRInputStream input = new ANTLRInputStream(new FileInputStream("/home/gabriela/trabalho2/trabalho2/src/trabalho3/casosDeTeste/semErros/entrada/exemplo1.faz"));
        ...
        if (saida.length() == 0 && naoEhSintatico){*/
            ...
            FAZEDORESLexer lexerGC = new FAZEDORESLexer(input);
